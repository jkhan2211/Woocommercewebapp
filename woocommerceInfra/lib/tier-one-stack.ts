...
export class TierOneStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const privateRoute = new ec2.CfnRoute(this, 'PrivateRoute', {
      ...
      new ec2.CfnSubnetRouteTableAssociation(this, 'PrivateAppSubnetRouteTableAssociation', {
        subnetId: privateAppSubnet1Id,
        routeTableId: routeTable.ref,
      });

      new ec2.CfnSubnetRouteTableAssociation(this, 'PrivateDataSubnetRouteTableAssociation', {
    ...
    const privateRoute_2 = new ec2.CfnRoute(this, 'PrivateRoute_2', {
      ...
      new ec2.CfnSubnetRouteTableAssociation(this, 'PrivateAppSubnetRouteTableAssociation2', {
        subnetId: privateAppSubnet2Id,
        routeTableId: routeTable_2.ref,
      });

      new ec2.CfnSubnetRouteTableAssociation(this, 'PrivateDataSubnetRouteTableAssociation2', {
